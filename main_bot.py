...
def show_start_menu():
    ...
    用户可以选择从哪个阶段开始运行状态机：
      [0] 自动循环 — 从 STATE_FARM_POINTS 开始完整四阶段循环
      [1] 刷技能点 — 进入 EventLab 自动跑图刷满 999 技能点
      [2] 买车      — 导航至 Car Collection → 批量购买 Subaru Impreza
      [3] 加技能点  — 进入车库 → 逐辆 Impreza 消耗技能点升级技能树
      [4] 卖车      — 进入车库 → 批量移除已升级完的 Impreza
    ...
    print("=" * 50)
    print()
    print("  [1] 🏎️  刷技能点  (STATE_FARM_POINTS)")
    print("       OCR 扫描当前技能点 → 自动跑 EventLab 刷满 999")
    print()
    print("  [2] 🛒  买车      (STATE_BUY_CARS)")
    print("       导航至 Car Collection → 批量购买 Subaru Impreza")
    print()
    print("  [3] ⚡  加技能点  (STATE_UPGRADE_CARS)")
    print("       进入车库 → 逐辆选择 Impreza 并消耗技能点升级")
    print()
    print("  [4] 🗑️  卖车      (STATE_TRASH_CARS)")
    print("       进入车库 → 批量移除已升级完的 Impreza")
    print()
    print("  [0] 🔄  自动循环  (默认：从刷点开始完整循环)")
    print()
    print("=" * 50)
